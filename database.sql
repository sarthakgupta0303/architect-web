-- =============================================================================
-- Architect 2.0 — database.sql
-- Complete database setup: schema (tables, enums, indexes, triggers, functions,
-- Row Level Security, Realtime, Storage buckets) + seed data (official templates,
-- demo-project generator).
--
-- HOW TO USE (Supabase):
--   1. Open your project → SQL Editor → New query.
--   2. Paste this entire file and click "Run". It runs in a single transaction:
--      if anything fails, nothing is applied.
--   3. Run it once on a project that does not already contain these objects.
--
-- Sources: docs/engineering/engineering-doc.md §7, docs/specs/supabase-schema.sql,
--          docs/specs/seed.sql
-- =============================================================================
...
-- ============================================================================
-- MIGRATION 002 — conversation memory (docs/specs/conversation-memory.md)
-- ============================================================================
begin;
...
-- Users may only write their own messages; assistant rows are written by the API on the
-- user's behalf (same session) and must reference that user as author.
...
-- ============================================================================
-- SECURITY HARDENING (supabase/rls-policies.sql)
-- ============================================================================
-- =============================================================================
